...
const TIPS = [
  ...
  },
  {
    ...
    short: 'Unter Abnehmspritzen geht neben Fett auch fettfreie Masse verloren, in STEP 1 knapp 40 Prozent des Gewichtsverlusts (DXA-Teilstudie, 140 Teilnehmende), über mehr als 40 DXA-Berichte im Mittel 29 Prozent. Ein guter Teil davon ist Wasser und Glykogen, nicht Muskel. Der belegteste Gegenzug bleibt Krafttraining mit ausreichend Eiweiß.',
    how: 'Zieh während der gesamten Gewichtsabnahme zwei Dinge parallel hoch: Krafttraining für die großen Muskelgruppen und eine Eiweißzufuhr, die nicht mit der Kalorienmenge mitsinkt. Diese Kombination hat mehr Untersuchungen hinter sich als beide Medikamentenkandidaten zusammen und wirkt unabhängig davon, wodurch das Gewicht sinkt. Miss dazu Funktion statt nur Gewebe, also Treppensteigen und Aufstehen aus dem Stuhl: In QUALITY mit 168 Menschen ab 60 Jahren über 16 Wochen hatten unter Enobosarm 19,4 statt 42,6 Prozent der Teilnehmer einen Abfall der Treppenleistung um mindestens 10 Prozent, also rund 54 Prozent weniger; das stammt aus einer Firmenmitteilung und ist bis September 2026 nicht begutachtet veröffentlicht. Belegt ist außerdem, dass der gemessene Verlust an fettfreier Masse nah an dem liegt, was jede Diät kostet, etwa 25 Prozent nach alter Faustregel gegenüber 38 Prozent in STEP 1 und etwa 25 Prozent unter Tirzepatid, und dass DXA dabei Wasser, Glykogen und Organgewebe mitzählt. Zwei Meta-Analysen von 2026 sind uneins, ob Inkretine mehr fettfreie Masse kosten als eine Diät (Eisa: kein signifikanter Unterschied, Lebensstil 26 Prozent; Busk-Cirera: 33 gegenüber 22 Prozent bei Diät ohne Bewegung), einig sind sie beim Training: 17,5 Prozent mit Krafttraining beziehungsweise 7,7 Prozent bei Diät mit Bewegung. In einer nachträglichen Kernspin-Auswertung unter Tirzepatid bei Typ-2-Diabetes (SURPASS-3 MRI, von Lilly finanziert) sank das Oberschenkelmuskelvolumen im für den Gewichtsverlust erwarteten Maß, die Fetteinlagerung im Muskel stärker als erwartet. Nicht belegt ist, dass die Medikamente gegen den Verlust am Ende Kraft oder Selbstständigkeit erhalten: Bimagrumab senkte in BELIEVE den Verlust fettfreier Masse von 6,9 auf 2,3 Prozent, gemessen wurde aber ebenfalls mit DXA, und unter Bimagrumab allein brachen 14 bis 21 Prozent der Teilnehmer die Behandlung ab, in den Kombinationsgruppen 5,5 bis 12,5 Prozent, unter Semaglutid allein 3,6 bis 8,9 Prozent und unter Placebo 3,6 Prozent. Enobosarm ist Ostarin (MK-2866), ein SARM, der auf der Dopingliste steht und nicht zugelassen ist; es gibt Fallberichte über Leberschäden, und Graumarktware ist nicht das Studienpräparat. Die Nachfolgestudie PLATEAU (239 Eingeschlossene ab 65 Jahren, 68 Wochen) hat die Gewichtsänderung als Hauptziel, Muskel und Treppenleistung sind Nebenziele; eine Zwischenauswertung kündigt Veru für das erste Quartal 2027 an.',
    tags: [
      'GLP-1',
      'Semaglutid',
      'Tirzepatid',
