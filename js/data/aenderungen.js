...
const AENDERUNGEN = [
  {
    ...
    text: 'Bisher stand die Berichtslage vor allem bei Einträgen mit dünner oder negativer Studienlage. Testosteron ist der umgekehrte Fall und zeigt, dass das Feld auch dort gebraucht wird, wo alles gut belegt ist: Human-Evidenz 9, Mechanismus 9, Sicherheits-Datenlage 9, Anwendungserfahrung 10. Die Wirkung ist unbestritten, und die Erfahrungsberichte sind so einheitlich wie bei kaum einem anderen Thema – mehr Antrieb, bessere Stimmung, mehr Libido, oft schon nach zwei bis drei Wochen. Genau das macht sie aber angreifbar: Dieselben Effekte werden auch von Männern mit normalen Ausgangswerten berichtet, und für diese Gruppe existiert keine Zulassungsstudie. Die TRAVERSE-Studie (Lincoff et al., NEJM 2023) randomisierte 5.246 Männer über im Mittel 27 Monate und fand kardiovaskuläre Nichtunterlegenheit, aber mehr Vorhofflimmern – 91 gegen 63 Fälle – und mehr akutes Nierenversagen. Das BfArM wies 2025 auf die stark steigende Verordnungshäufigkeit hin, die teils außerhalb der Zulassung erfolgt. Die Berichtslage belegt hier also, dass der Stoff wirkt, nicht dass die Behandlung angezeigt war. Das Etikett bleibt davon unberührt und lautet weiterhin „Gut belegt, stark überhöht beworben" – der Hype-Abstand von 4 bezieht sich genau auf diese Verschiebung von der Indikation zur Lifestyle-Anwendung.',
    ziel: { view: 'experimental', id: 'testosteron' },
    quelle: { titel: 'TRAVERSE: Cardiovascular Safety of Testosterone-Replacement Therapy (NEJM 2023)', url: 'https://www.nejm.org/doi/full/10.1056/NEJMoa2215025' }
  },
  {
    datum: '2026-09-02',
    typ: 'Korrektur',
    titel: 'Berichtslage jetzt auch bei den Negativ-Einträgen – dort, wo sie am meisten trägt',
    text: 'Das Feld „Was berichtet wird" stand bisher fast ausschließlich bei Einträgen mit der Richtung „offen". Das war ein Denkfehler: Die stärkste Spannung entsteht nicht dort, wo wenig bekannt ist, sondern dort, wo die Studienlage klar Nein sagt und trotzdem viele Menschen etwas berichten. Von den sechzehn Negativ-Einträgen haben zwölf eine Anwendungserfahrung von 6 oder höher, sind also breit verwendet – bewertet war die Berichtslage aber nur bei Selen. Vierzehn der sechzehn tragen sie jetzt; nur AOD-9604 und Larazotid bleiben ohne, weil es dort praktisch keine Anwendung außerhalb von Studien gibt. Das Etikett bleibt unverändert rein evidenzbasiert – „Gut untersucht – Wirkung nicht bestätigt" heißt weiterhin genau das. Daneben steht künftig, was Anwender beobachten, und das ist bei mehreren Einträgen eine eigene Geschichte. Glucosamin ist der Musterfall: Millionen nehmen es seit Jahrzehnten, viele berichten weniger Knieschmerz, und zugleich zeigte sich der Effekt in den Herstellerstudien und in den unabhängigen nicht. Bei MK-677 berichten Anwender etwas nachweislich Reales – Hunger binnen Stunden und einen im Blutbild messbaren IGF-1-Anstieg –, nur folgt daraus nicht der beworbene Nutzen an Kraft und Körperzusammensetzung; die Berichte belegen den Mechanismus, nicht das Versprechen. Bei PRP steht der Patientenbericht neben der entscheidenden Zahl aus der verblindeten Studie, in der es der Kochsalzgruppe genauso gut ging: Eine Spritze ins Knie ist eine der wirksamsten Scheinbehandlungen, die die Medizin kennt – die Besserung ist echt, die Zuordnung zum Eigenblut ist es nicht. Bei Dual-N-Back ist das berichtete Gefühl, schärfer zu sein, genau das, was die Meta-Analysen gemessen und als nicht übertragbar befunden haben. Und bei Ginkgo ist das Ausbleiben spezifischer Berichte selbst die Information: Bei millionenfacher Einnahme über Jahrzehnte wäre ein spürbarer Effekt längst in Form konkreter Beobachtungen aufgetaucht. Neu ist außerdem ein Kurzfeld in der Berichtslage, das für die Videoformate gebraucht wird – damit unter dem roten Fazit eines Kurzvideos nicht nur „Wirkung nicht bestätigt" steht, sondern daneben, was Anwender berichten.',
  },
  {
    datum: '2026-09-02',
    typ: 'Korrektur',
    titel: 'Drei Behandlungen hatten eine Karte, aber keinen BK-Score: INUSpherese, IHHT und Infrarot-A',
    text: 'Bei der Dublettenprüfung fiel auf, dass drei Einträge in der Behandlungsübersicht standen, ohne bewertet zu sein – die zugehörigen Podcast-Folgen waren bereits geplant. Alle drei sind jetzt eingeordnet. Bei der INUSpherese ist die Fachgesellschaft eindeutig: Die Deutsche Gesellschaft für Nephrologie stellte 2022 fest, dass keine randomisierten kontrollierten Studien existieren, sondern unkontrollierte Fallserien, bei denen Störvariablen nicht auszuschließen sind, und fordert solche Studien ein; ohne sie sei keine generelle Empfehlung möglich. Hinzu kommt eine Verschiebung der Behauptung: Untersucht wurde die Entfernung von Autoantikörpern, beworben wird die Entfernung von Umweltgiften – dass ein Filter etwas aus dem Blut holt, ist plausibel und teils messbar, dass dies die Beschwerden verursacht hat, ist der ungeprüfte Teil. Bei IHHT liegt mit 145 Long-COVID-Patienten in stationärer Rehabilitation die größte Arbeit vor (Doehner et al., Journal of Cachexia, Sarcopenia and Muscle 2024) mit einer deutlich verbesserten Gehstrecke von 91,7 gegenüber 32,6 Metern. Entscheidend ist das Design: nicht randomisiert und unverblindet, bei einem Endpunkt, der von der Anstrengungsbereitschaft abhängt – die Arbeit hat in derselben Zeitschrift eine veröffentlichte methodische Kritik samt Autorenantwort nach sich gezogen. Infrarot-A ist der Gegenfall und im Bestand selten: Für die Wundheilung gibt es sechs randomisierte Studien, darunter eine mit 400 Patienten, mit harten Zahlen wie einem Ulkusverschluss nach 14 statt 42 Tagen. Diese Daten betreffen aber Wundheilung und perioperative Infektionen, nicht die im Biohacking beworbene Regeneration; und der Erstautor der zusammenfassenden Übersicht arbeitet für eine Stiftung, die die Forschung zu diesem Verfahren fördert. Nachträglich korrigiert wurde die Evidenz-Achse der INUSpherese von 1 auf 2: Eine 1 hätte das Etikett „Nicht am Menschen untersucht" erzeugt, und das ist falsch – das Verfahren wird an vielen Menschen durchgeführt, nur eben ohne kontrollierte Prüfung. Genau dafür sieht die Skala die 2 vor.',
    quelle: { titel: 'DGfN: Stellungnahme zur Apheresetherapie bei Long-/Post-COVID-Syndrom', url: 'https://www.dgfn.eu/stellungnahmen-details/apheresetherapie-long-post-covid-syndrom.html' }
  },
  {
    datum: '2026-09-02',
    typ: 'Korrektur',
